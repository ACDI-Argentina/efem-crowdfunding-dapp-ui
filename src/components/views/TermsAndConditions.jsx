    ...
    <div className="row">
      <div className="col-md-10 m-auto">
        ...
        <p>
          ...
          and complete. Don’t impersonate anyone else or choose names that are offensive or that
          violate anyone’s rights. If you don’t follow these rules, we may cancel your account.
        </p>
        <p>
        ...
        <p>
          ...
          laws, abuse people, Impersonate someone else, steal money or data, hack other people’s
          computers, and DO NOT MESS with our system. Please behave yourself. Don’t do this stuff.
        </p>
        <p>
          We expect everyone to behave responsibly and help keep this a nice place. Don’t do any of
          these things on the Dapp:
        </p>
        <ul>
          <li>
            Don’t break the law. Don’t take any action that infringes or violates other people’s
            rights, violates the law, or breaches any contract or legal duty you have toward anyone.
          </li>
          <li>
          ...
          <li>
            Don’t victimize anyone. Don’t do anything threatening, abusive, harassing, defamatory,
            libelous, tortious, obscene, profane, or invasive of another person’s privacy.
          </li>
          <li>
            Don’t spam. Don’t distribute unsolicited or unauthorized advertising or promotional
            material, or any junk mail, spam, or chain letters. Don’t run mail lists, listservs, or
            any kind of auto-responder or spam on or through the Dapp.
          </li>
          <li>
        ...
        <h1>3. Things YOU must refrain from doing with the Dapp</h1>
        <ul>
          <li>Don’t try to interfere with the proper workings of the dapp.</li>
          <li>
            Don’t bypass any measures we’ve put in place to secure the process of traceability.
          </li>
          <li>
        ...
        <p>
          <strong>Regarding your Content: </strong>
        </p>
        <ul>
          <li>
            Your Content does not contain or install any viruses, worms, malware, Trojan horses or
            other harmful or destructive content;
          </li>
          <li>
            Your Content is not spam, is not machine-or randomly-generated, and does not contain
            unethical or unwanted commercial content designed to drive traffic to third party sites
            or boost the search engine rankings of third party sites, or to further unlawful acts
            (such as phishing) or mislead recipients as to the source of the material (such as
            spoofing);
          </li>
          <li>
            Your Content is not pornographic, does not contain threats or incite violence, and does
            not violate the privacy or publicity rights of any third party;
          </li>
          <li>
            Your content is not getting advertised via unwanted electronic messages such as spam
            links on newsgroups, email lists, blogs and websites, and similar unsolicited
            promotional methods;
          </li>
          <li>
            Your content is not named in a manner that misleads your readers into thinking that you
        ...
        <p>
          Throughout the process, Builders owe their Supporters a high standard of effort, honest
          communication, and a dedication to bringing the project to life. At the same time,
          supporters must understand that when they support a project, they’re helping to create
          something special, altruistic and that their contribution is only part of the holistic
          effort that involves executing the project.
        </p>
        <p>
          There may be changes or delays, and there’s a chance something could happen that prevents
          the Builder from being able to finish the project as promised.
        </p>
        <p>
          If a Builder is unable to complete their project and fulfill the milestones, they’ve
          failed to live up to the basic obligations of this agreement. To right this, they must
          make every reasonable effort to find another way of bringing the project to the best
          possible conclusion for supporters. A Builder in this position has only remedied the
          situation and met their obligations to supporters, if:
        </p>
        <ul>
          <li>
            they post an update that explains what work has been done, how funds were used, and what
            prevents them from finishing the project as planned;
          </li>
          <li>
            they work diligently and in good faith to bring the project to the best possible
            conclusion in a timeframe that’s communicated to supporters;
          </li>
          <li>
            they’re able to demonstrate that they’ve used funds appropriately and made every
            reasonable effort to complete the project as promised;
          </li>
          <li>
            they’ve been honest, and have made no material misrepresentations in their communication
            to supporters; and
          </li>
          <li>
            they offer to return any remaining funds to supporters who have not received their
            reward (in proportion to the amounts pledged), or else explain how those funds will be
            used to complete the project in some alternate form.
          </li>
        </ul>
        <p>
          The Builder is solely responsible for fulfilling the promises made in their project. If
          they’re unable to satisfy the terms of this agreement, they may be subject to legal action
          by the community.
        </p>
        <h1>5. Funds Management</h1>
        <p>
        ...
        <ul>
          <li>
            Your donation will be released to the Builder only if milestones are approved. You’ll
            provide your contribution information when you pledge, we will not accept contributions
            larger than 10K USD. Your donation will only be collected if, at the time of the
            project’s funding timelines, the project has reached its milestones goal. The exact
            amount you donated is the amount sent to the smart contracts and the amount that will be
            collected. If the milestones are not reached and canceled, the donation will be returned
            to the donors or the entities who delegated the donation to the milestone.
          </li>
          <li>
            We do not take credit cards or bank transfers, all donations are made in whitelisted
            cryptocurrencies (currently RBTC).
          </li>
          <li>
            You can not change or cancel your pledge (with one exception). As we are using on chain
            transactions, it is difficult to make changes to your contribution. If you donated to
            Campaign or Milestone, you will only be refunded if they are canceled. If you donated to
            a Fund you are able to withdraw your donation at any time.
          </li>
          <li>
            <strong>
        ...
        <ul>
          ...
          <li>
            ...
            development of the projects in accordance to a roadmap.
          </li>
          <li>
            The funds allocated to milestones will cover the costs of resources assigned to provide
            business, technical and legal support to projects.
          </li>
        ...
        <h3>Information you need to know if you are a Builder and who is managing a project</h3>
        <p>These are the terms that apply when you’re creating a project:</p>
        <ul>
          <li>
            You can refund individual pledges if you want. After your project has been funded, you
            can cancel and refund a supporter’s pledge at any time. If you do, you have no further
          ...
          <li>
            We cannot help resolve payment disputes. If a supporter of your project disputes the
            donation. You’ll be notified that a dispute has been filed, and you’ll be able to
            provide evidence to help us resolve it in your favor.
          </li>
          <li>
            Don’t count your chickens before they hatch. Don’t assume you’ll be able to launch your
            project when you want; there could be a reason we’re not able to accept it, or a problem
            that takes time to resolve. Don’t assume you’ll be able to immediately collect your
            funding; there may be a delay between the end of a successful campaign and your access
            to the funds. And don’t take any actions in reliance on collecting any of the money
            pledged until you actually have the ability to withdraw it from your account and spend
            it.
          </li>
        </ul>
        ...
        <p>
          ...
          any resulting damage or loss to any party.
        </p>
        <h1>7. Other Websites</h1>
        <p>
        ...
        <ul>
          <li>
            We can use the content you’ve submitted. You grant to us, and others acting on our
            behalf, the worldwide, non-exclusive, perpetual, irrevocable, royalty-free,
          ...
          <li>
            When we use the content, we can make changes, like editing or translating it. You grant
            us the right to edit, modify, reformat, excerpt, delete, or translate any of your
            Content.
          </li>
          <li>
        ...
        <p>
          ...
          A “commercial purpose” means you intend to use, sell, license, rent, or otherwise exploit
          content for commercial use, in any way.
        </p>
        <h1>10. How We Deal with Copyright Issues</h1>
        <p>
          We comply with the Digital Millennium Copyright Act. To learn more about how we deal with
          claims of copyright infringement, read our Copyright Policy.
        </p>
        <p>
          We reserve the right to delete or disable content alleged to be infringing, and to
          terminate accounts for repeat infringers (we do this when appropriate and at our sole
          discretion.)
        </p>
        <h1>11. Deleting Your Account</h1>
        <p>
          You may request to delete your account at any time. Deleting your account won’t
          automatically make some content you’ve already posted go away as this content may reside
          on an on-chain network where it cannot be deleted.
        </p>
        <p>
        ...
        <h1>12. Our Rights</h1>
        <p>
          To comply and keep things running smoothly, we need to be able to maintain control over
          what happens on our website. So in this section, we reserve the right to make decisions to
        ...
        <p>
          We work in good faith and try our best efforts to maintain a compliant, efficient and
          transparent environment, but we can’t guarantee everything will always work perfectly.
          This site is presented as-is, without warranties.{' '}
          <strong>
            You use our Site and Dapp versions solely at your own risk. They are provided to you “as
        ...
        <p>
          ...
          they’re the last word.) Thanks so much for reading them, we know how painful it can be.
        </p>
        <p>
